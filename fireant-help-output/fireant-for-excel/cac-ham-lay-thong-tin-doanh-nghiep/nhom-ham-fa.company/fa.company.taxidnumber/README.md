---
title: "FA.Company.TaxIDNumber"
source: "https://help.fireant.vn/fireant-for-excel/cac-ham-lay-thong-tin-doanh-nghiep/nhom-ham-fa.company/fa.company.taxidnumber"
---

# FA.Company.TaxIDNumber

## **Cú pháp**

```
=FA.Company.TaxIDNumber("Mã CK")
```
