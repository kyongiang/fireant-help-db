---
title: "FA.Historical.Close"
source: "https://help.fireant.vn/fireant-for-excel/cac-ham-lay-du-lieu-giao-dich-qua-khu/nhom-ham-fa.historical/fa.historical.close"
---
...
```
=FA.Historical.Close("Mã CK", "Ngày bắt đầu", "Ngày kết thúc")
```
