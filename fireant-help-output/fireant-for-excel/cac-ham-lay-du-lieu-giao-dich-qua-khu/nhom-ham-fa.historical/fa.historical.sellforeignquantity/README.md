---
title: "FA.Historical.SellForeignQuantity"
source: "https://help.fireant.vn/fireant-for-excel/cac-ham-lay-du-lieu-giao-dich-qua-khu/nhom-ham-fa.historical/fa.historical.sellforeignquantity"
---

# FA.Historical.SellForeignQuantity

## Cú pháp

```
=FA.Historical.SellForeignQuantity("Mã CK", "Ngày bắt đầu", "Ngày kết thúc")
```
