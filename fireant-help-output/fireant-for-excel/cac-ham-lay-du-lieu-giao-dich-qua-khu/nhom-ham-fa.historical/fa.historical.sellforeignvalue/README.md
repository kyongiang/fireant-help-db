---
title: "FA.Historical.SellForeignValue"
source: "https://help.fireant.vn/fireant-for-excel/cac-ham-lay-du-lieu-giao-dich-qua-khu/nhom-ham-fa.historical/fa.historical.sellforeignvalue"
---

# FA.Historical.SellForeignValue

## Cú pháp

```
=FA.Historical.SellForeignValue("Mã CK", "Ngày bắt đầu", "Ngày kết thúc")
```
