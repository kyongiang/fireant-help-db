---
title: "FA.Historical.BuyForeignValue"
source: "https://help.fireant.vn/fireant-for-excel/cac-ham-lay-du-lieu-giao-dich-qua-khu/nhom-ham-fa.historical/fa.historical.buyforeignvalue"
---

# FA.Historical.BuyForeignValue

## Cú pháp

```
=FA.Historical.BuyForeignValue("Mã CK", "Ngày bắt đầu", "Ngày kết thúc")
```
