---
title: "FA.Historical.BuyForeignQuantity"
source: "https://help.fireant.vn/fireant-for-excel/cac-ham-lay-du-lieu-giao-dich-qua-khu/nhom-ham-fa.historical/fa.historical.buyforeignquantity"
---

# FA.Historical.BuyForeignQuantity

## Cú pháp

```
=FA.Historical.BuyForeignQuantity("Mã CK", "Ngày bắt đầu", "Ngày kết thúc")
```
