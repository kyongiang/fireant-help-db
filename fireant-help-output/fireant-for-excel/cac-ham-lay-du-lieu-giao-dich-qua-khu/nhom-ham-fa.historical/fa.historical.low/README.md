---
title: "FA.Historical.Low"
source: "https://help.fireant.vn/fireant-for-excel/cac-ham-lay-du-lieu-giao-dich-qua-khu/nhom-ham-fa.historical/fa.historical.low"
---
...
```
=FA.Historical.Low("Mã CK", "Ngày bắt đầu", "Ngày kết thúc")
```
