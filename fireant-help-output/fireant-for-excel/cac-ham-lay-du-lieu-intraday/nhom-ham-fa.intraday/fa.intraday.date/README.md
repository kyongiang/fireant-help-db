---
title: "FA.Intraday.Date"
source: "https://help.fireant.vn/fireant-for-excel/cac-ham-lay-du-lieu-intraday/nhom-ham-fa.intraday/fa.intraday.date"
---
...
```
=FA.Intraday.Date("Mã CK hoặc Mã Index","Lần khớp")
```

Hàm FA.Intraday.Date có các tham số sau:

* **Mã chứng khoán**: Mã chứng khoán của cổ phiếu cần lấy thông tin, hoặc index (VNINDEX, HNXINDEX, UPCOM, VN30, HNX30,...&#x20;
* **Lần khớp:** Thứ tự lần khớp (1, 2,... tương ứng với lần khớp gần nhất, gần nhì,...)

Trả về

Thời gian khớp lệnh trong ngày của 1 mã hoặc index

**Ví dụ:**

Để lấy thời gian khớp lệnh của mã FPT tương ứng với lần khớp thứ 10 trước lần khớp gần nhất, ta dùng công thức sau:

```
=FA.Intraday.Date("FPT",10)
```
